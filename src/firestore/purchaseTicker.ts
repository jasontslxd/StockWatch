import { addDoc, collection, Firestore, query, where, getDocs, updateDoc, doc } from "firebase/firestore";
import { User } from "firebase/auth";

export const purchaseTicker = async (firestore: Firestore, user: User, ticker: string, quantity: number, price: number) => {
  try {
