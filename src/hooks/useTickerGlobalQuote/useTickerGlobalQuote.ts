import { ITickerGlobalQuote, ITickerGlobalQuoteApiResponse, IReactQueryResponse } from "common";
import { parseGlobalQuote } from "./useTickerGlobalQuote.service";
import { useQuery } from "@tanstack/react-query";

export const useTickerGlobalQuote = (ticker?: string): IReactQueryResponse<ITickerGlobalQuote> => {
  ...
  const { isPending, error, data } = useQuery({
    ...
    queryFn: ticker ? (): Promise<ITickerGlobalQuoteApiResponse> =>
