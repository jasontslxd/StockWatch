...
export const mapTickerMovementTimeRangeToTimeSeriesFrequency = (
...
export const mapTickerHistoricalPrice = (
  response: ITickerTimeSeriesApiResponse,
  frequency: TickerTimeSeriesFrequency,
): ITickerPriceData[] => {
  const priceData =
    response[
