...
export const TickerNewsSummary = ({ ticker }: ITickerNewsSummaryProps) => {
      ...
      return (
        <div className="d-flex flex-column align-items-center">
          ...
          <p className="text-center">
            Oh no! Something went wrong loading the news. Please try again
            later.
          </p>
  ...
  const renderTickerNewsModal = () => {
    return (
      <Modal
        centered
        show={showTickerNewsModal}
        onHide={() => setShowTickerNewsModal(false)}
      >
        <Modal.Header closeButton>
          <Modal.Title>Top news for {ticker}</Modal.Title>
        </Modal.Header>
        <Modal.Body>{renderTickerNewsSummary(true)}</Modal.Body>
      </Modal>
    );
  };
  return (
    <>
      <div className="d-flex justify-content-between align-items-center">
        ...
        <Button
          ...
          onClick={() => setShowTickerNewsModal(true)}
        >
